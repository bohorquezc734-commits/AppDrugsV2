        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArchivoAutorizacion = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_GestoresFarmaceuticos_GestorFarmaceuticoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppointmentDetails_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentDetails_InventoryId",
                table: "AppointmentDetails",
                column: "InventoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_GestorFarmaceuticoId",
                table: "Appointments",
